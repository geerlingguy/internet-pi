...
Other features:
  ...
  - **Temperature Probe Monitoring**: Tracks temperature reported by probes connected via one-wire communication (e.g. [DS18B20](https://blog.robertelder.org/ds18b20-raspberry-pi-setup-pullup/)). Enable and configure using the `temp_probes_enable` var in `config.yml`.
